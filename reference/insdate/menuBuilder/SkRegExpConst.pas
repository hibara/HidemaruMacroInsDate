...
resourcestring
  ...
  sCannotCallMultipleDefineGroupName    = '%s多重定義されたグループ名<%s>の部分式は呼び出せません';
  // check!
...
{$IFDEF DEBUG}
  { for debug }
  sFmtUnicodeProperty                   = 'Char($%x)';
  sFmtNegativeUnicodeProperty           = 'Char %s ($%x)';
  sLiteral                              = 'EXACT <%s> ';
  sLiteralRepeat                        = 'REPEAT <%s> ';
  sAnyChar                              = 'ANY ';
  sWordChar                             = 'WORD ';
  ...
  sLoopTypeGreedy                       = 'Greedy';
  sLoopTypeReluctant                    = 'Reluctant';
  sLoopTypePossessive                   = 'Possessive';
  ...
  sFmtDumpNFA_NoBackTrackBegin          = 'NBACKTRS (%d) :';
